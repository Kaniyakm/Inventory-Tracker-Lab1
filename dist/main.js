...
const hairExtensions = new PhysicalProduct_1.PhysicalProduct("SKU-001", "Hair Extensions", 1200, 2.5 // weight in kg
);
const kolorEbook = new DigitalProduct_1.DigitalProduct("SKU-002", "Kolor Ebook", 19.99, 5 // file size in MB
);
